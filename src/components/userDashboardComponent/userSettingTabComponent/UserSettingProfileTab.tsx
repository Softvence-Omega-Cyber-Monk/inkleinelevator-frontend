...
const UserSettingProfileTab: React.FC<UserSettingProfileTabProps> = ({}) => {
  ...
  const { data, refetch } = useGetMeUserWonDataQuery({});
        ...
        <div className="space-y-6">
          ...
          <div className="pt-4">
            <Button
              ...
              disabled={isLoading}
              className="bg-[#1e3a5f] cursor-pointer hover:bg-[#2d4a6f] text-white px-6 py-2.5 rounded-lg font-medium disabled:opacity-50 disabled:cursor-not-allowed"
            >
